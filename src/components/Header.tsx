              ...
              <div className="relative flex items-center justify-between h-20">
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                  <button
                    ...
                    className=" hidden lg:block bg-violet-600 px-6 py-2.5 shadow-lg shadow-violet-600/30 rounded-full font-medium text-white hover:bg-violet-700 focus:outline-none focus:ring-4 focus:ring-violet-600/20 transition-all duration-300 hover:scale-105"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => window.location.href = "https://api.whatsapp.com/send?phone=5512991316484&text=Ol%C3%A1,%20gostaria%20de%20saber%20mais%20informa%C3%A7%C3%B5es%20a%20respeito%20do%20e-commerce"}
                    className="block lg:hidden bg-violet-600 px-4 py-2 pt-2.5 rounded-full font-medium text-white hover:bg-violet-700 transition"
                  >
                    Contato
