...
export default function Footer() {
  return(
    <footer className="relative mt-16 bg-violet-950">
      <svg
        className="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-violet-950"
      ...
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            ...
            <div>
              ...
              <ul className="mt-2 space-y-2">
                <li>
                  <Link
                    href="/ecommerce"
                    className="transition-colors duration-300 text-violet-50 hover:text-cyan-400"
                  >
                    e-Commerce
                  </Link>
                </li>
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-violet-800 sm:flex-row">
          <p className="text-sm text-gray-300">
            © Copyright {new Date().getFullYear()} Solux Creative. All rights reserved.
          </p>
          <div className="flex items-center mt-4 space-x-4 sm:mt-0">
            <Link
              href="#"
              className="transition-colors duration-300 text-violet-100 hover:text-cyan-400"
            >
              <Image 
